...
class NgxDropzoneComponent {
  ...
  extractFilesFromDirectory(directory) {
    ...
    function _getFileFromFileEntry() {
      _getFileFromFileEntry = (0,D_MyProject_WINPOSZ_ONLINE_EZPOS_FRN_CUBA_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fileEntry) {
        try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const readEntries = () => {
        dirReader.readEntries( /*#__PURE__*/function () {
          var _ref = (0,D_MyProject_WINPOSZ_ONLINE_EZPOS_FRN_CUBA_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dirItems) {
            if (!dirItems.length) {
              resolve(files);
            } else {
