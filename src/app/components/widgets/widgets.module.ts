...
@NgModule({
  ...
  imports: [CommonModule, WidgetsRoutingModule, NgbModule, CarouselModule, ChartistModule, NgChartsModule, FormsModule, SharedModule, NgApexchartsModule, DashboardModule],
})
