...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      active: false,      
      children: [
        { path: "/inventory/rpbymodel", title: "แยกตามรุ่น/ByModel", icon: "bonus-kit", type: "link" ,bookmark: true},   
        // { path: "/inventory/rpbybrand", title: "แยกตามยี่ห้อ/ByBrand", type: "link" },   
        { path: "/inventory/rpbyitem", title: "แยกตามสินค้า/ByItem", type: "link" },   
        { path: "/inventory/report", title: "ประวัติ", type: "link", icon: "bonus-kit" ,bookmark: true },   
      ],
    },
    {  // RpBydocComponent
    ...
    },
    {
      ...
      active: false,
      children: [
        { path: "/widgets/generalX", title: "General", type: "link" },
    ...
    { path: "/bookmarks", title: "Bookmarks", icon: "bookmark", type: "link"},
    { path: "/contacts", title: "Contact", icon: "contact", type: "link" },
    { path: "/tasks", title: "Tasks", icon: "task", type: "link"},
